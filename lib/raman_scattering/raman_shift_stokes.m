function [delta_n] = raman_shift_stokes(J, molecular_parameters)
% RAMAN_SHIFT_STOKES Calculate the rotational Raman shift for the Stokes branch
% for quantum number J.
%
% USAGE:
%    [delta_n] = raman_shift_stokes(J, molecular_parameters)
%
% INPUTS:
%    J: numeric
